...
import com.example.quizapp.utils.spConstants
...
class SportsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList = spConstants.getQuestions()
        Log.d("QuestionSize","${questionsList.size}")

        setQuestion()
        if(intent.hasExtra(spConstants.USER_NAME)){
            name = intent.getStringExtra(spConstants.USER_NAME)!!
        }
