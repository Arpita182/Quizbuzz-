...
class cntryActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList = CountryCons.getQuestions()
        Log.d("QuestionSize","${questionsList.size}")

        setQuestion()
        if(intent.hasExtra(CountryCons.USER_NAME)){
            name = intent.getStringExtra(CountryCons.USER_NAME)!!
        }
    ...
    private fun setQuestion() {
        ...
        if (questionsCounter < questionsList.size) {
            ...
            Intent(this, cnResult::class.java).also{
                it.putExtra(CountryCons.USER_NAME, name)
                it.putExtra(CountryCons.SCORE, score)
                it.putExtra(CountryCons.TOTAL_QUESTIONS, questionsList.size)
