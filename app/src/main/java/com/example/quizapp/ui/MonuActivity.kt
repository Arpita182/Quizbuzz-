...
import com.example.quizapp.utils.monuCons

class MonuActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        questionsList = monuCons.getQuestions()
        Log.d("QuestionSize","${questionsList.size}")

        setQuestion()
        if(intent.hasExtra(monuCons.USER_NAME)){
            name = intent.getStringExtra(monuCons.USER_NAME)!!
        }
    ...
    private fun setQuestion() {
        ...
        if (questionsCounter < questionsList.size) {
            ...
            Intent(this, ResultActivity::class.java).also{
                it.putExtra(monuCons.USER_NAME, name)
                it.putExtra(monuCons.SCORE, score)
                it.putExtra(monuCons.TOTAL_QUESTIONS, questionsList.size)
